                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    ...
                                    Sale 20% Off
                                        ...
                                        <p>
                                            if you want to know more , go to offers
                                        </p>
                                        <div class="btn-box">
                                            <a href="{{ url('/offers') }}" class="btn1">
                                                Offers now
                                            </a>
                                        </div>
                                    </div>
    ...
    <section class="why_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                @auth
                <h2>
                    {{ucfirst(strtolower(\Illuminate\Support\Facades\Auth::user()->name))}} , Why Shop With Us
                </h2>
                    @else
                    <h2>
                        Why Shop With Us
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                    <div class="box">
                        <div class="option_container">
                            <div class="options">
                                <a href="{{url($product->title.'/'.$product->id.'/details')}}" class="option1">
                                    {{$product->title}}
                                </a>
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="subscribe_form ">
                            <div class="heading_container heading_center">
                                <h3>Join now to our website </h3>
                            </div>
                            <p>To know discount offers immediately</p>

                            <form action="{{ url('/redirect-to-register') }}" method="GET">
                                @csrf
                                <input type="email" placeholder="Enter your email or phone Number" name="email2">
                                <button type="submit">
                                    Join Now
                                </button>
                            </form>
...
@endguest
                    ...
                    <div class="carousel-item active">
                        <div class="box col-lg-10 mx-auto">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                    It is the best ecommerce website I deal with
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="box col-lg-10 mx-auto">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                   The SHESHTAWY offers are the best.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    @else
        <h1 style="text-align: center; margin-left: 440px">No results found!</h1><br><br>
